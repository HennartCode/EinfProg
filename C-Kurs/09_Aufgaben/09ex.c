...
bool free_pancake(PileOfPancakes p) {
    ...
    // PileOfPancakes *next_to_free = p.further_layers;
    // free(&p);
    // while (next_to_free != NULL){
    //     PileOfPancakes *freenow = malloc(sizeof(PileOfPancakes*));
    //     freenow = next_to_free;
    //     free(freenow);
    //     next_to_free = next_to_free->further_layers;
